...
call DoTest.bat [--] Simple-str "Day in human format: 1 day 12 h 0 m 0.50 s"  FormatTime "1 day 12 h 0 m 0.50 s" exact 12960050 -h
call DoTest.bat [--] Simple-str "Days in human format: 2 days 2 h 5 m 1.50 s" FormatTime "2 days 2 h 5 m 1.50 s" exact 18030150 -h
call DoTest.bat [--] Simple-str "Seconds in machine format: 00:00:02.89"      FormatTime "00:00:02.89"           exact 289 -m
